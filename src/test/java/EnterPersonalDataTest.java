...
public class EnterPersonalDataTest {
    ...
    public EnterPersonalDataTest(String firstName, String lastName, String address, String phone) {
    ...
    @Test
    public void validPersonalDataOrderTest() {
